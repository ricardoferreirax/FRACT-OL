...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/03 19:41:34 by rmedeiro          #+#    #+#             */
/*   Updated: 2025/08/03 19:41:54 by rmedeiro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_burning_ship(t_fractal *fractal)
{
	...
	while (y < fractal->res_height)
	{
		...
		while (x < fractal->res_width)
		{
			...
			iter = burning_ship(fractal->c_re, fractal->c_im, fractal->max_iter);
	...
	mlx_put_image_to_window(fractal->mlx,
		fractal->win, fractal->img.img, 0, 0);
}
